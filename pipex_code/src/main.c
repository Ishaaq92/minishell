...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/12 19:07:49 by avalsang          #+#    #+#             */
/*   Updated: 2025/02/21 21:22:59 by abhi             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// loop through data->cmd_list, create a child process with each one (happens inside pipex())
void	exec_cmd(t_data *data, char **argv, char **envp)
{
	t_list	*temp;
	int		fd[2];
